...
def get_args(args=None):
    ...
    parser.add_argument("--log_dir", type=str, default=f"/home/ma-user/work/LLMTM/logs/{osp.split(osp.dirname(__file__))[-1]}", help="log directory to put generated data and logs")
