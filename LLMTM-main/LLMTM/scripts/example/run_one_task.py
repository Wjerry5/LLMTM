...
# python scripts/example/run_one_task.py --task sort_edge --T 5 --N 10 --p 0.3 --num_seed 100 -t gen
# 2. Check the status of the 'sort_edge' task
# python scripts/example/run_one_task.py --task sort_edge --T 5 --N 10 --p 0.3 -t check
# 3. Run the gpt-4o-mini model for the 'sort_edge' task to get answers
# python scripts/example/run_one_task.py --task sort_edge --T 5 --N 10 --p 0.3 -t run --model gpt-4o-mini --k 1 --add_cot 1 
# 4. Evaluate the results of gpt-4o-mini on the 'sort_edge' task (using the same suffix parameters as run)
# python scripts/example/run_one_task.py --task sort_edge --T 5 --N 10 --p 0.3 -t eval --model gpt-4o-mini --k 1 --add_cot 1 
# 5. Display the evaluation results of gpt-4o-mini on the 'sort_edge' task (using the same suffix parameters as eval)
# python scripts/example/run_one_task.py --task sort_edge --T 5 --N 10 --p 0.3 -t show --model gpt-4o-mini --k 1 --add_cot 1 
# 6. (Optional) Clean up the data for the 'sort_edge' task
# python scripts/example/run_one_task.py --task sort_edge --T 5 --N 10 --p 0.3 -t clear
