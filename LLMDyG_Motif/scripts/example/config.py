...
def get_args(args=None):
    ...
    parser.add_argument("--log_dir", type=str, default=f"/home/ma-user/work/LLMDyG_Motif/logs/{osp.split(osp.dirname(__file__))[-1]}", help="log directory to put generated data and logs")
    ...
    parser.add_argument("--model", type=str, default='Qwen_14B', help="model name")
    ...
    parser.add_argument("--dataset", type=str, default="random", help="")    
